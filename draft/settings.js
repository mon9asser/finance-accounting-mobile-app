                ...
                <ScrollView style={{padding: 20}}>
                    ...
                    <View style={{borderBottomWidth: 1, borderBottomColor: "#ddd", padding: 10}}>
                        ...
                        <View style={{marginTop: 30, flexDirection: "column"}}>
                            <Text style={{flexGrow: 1, marginBottom: 10}}>User Name:</Text>
                            <TextInput  style={{flex: 1, color:"#999", backgroundColor: '#f9f9f9', padding: 5}}  placeholder="User Name" />
                        </View>
                        <View style={{marginTop: 30, flexDirection: "column"}}>
                            <Text style={{flexGrow: 1, marginBottom: 10}}>User Email:</Text>
                            <TextInput  style={{flex: 1, color:"#999", backgroundColor: '#f9f9f9', padding: 5}}  placeholder="Email" />
                        </View>
                        <View style={{marginTop: 30, flexDirection: "column"}}>
                            <Text style={{flexGrow: 1, marginBottom: 10}}>Password:</Text>
                            <TextInput  style={{flex: 1, color:"#999", backgroundColor: '#f9f9f9', padding: 5}}  placeholder="Password" />
                        </View>
                        <View style={{marginTop: 30, flexDirection: "column"}}>
                            <Text style={{flexGrow: 1, marginBottom: 10}}>Confirm Password:</Text>
                            <TextInput  style={{flex: 1, color:"#999", backgroundColor: '#f9f9f9', padding: 5}}  placeholder="Confirm Password" />
                        </View>
                    </View>
