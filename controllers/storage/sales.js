...
class Sales extends A_P_I_S {
    ...
    create_update = async ({invoice_number, invoice_status, payment_status, payment_method, order_type, customer, branch, date, total, subtotal, discount, tax, vat, shipping_or_delivery_cost , file, param_id} = null ) => {
       
        
        var _object =  { 
            invoice_number: invoice_number == undefined? "": invoice_number, 
            
            invoice_status: invoice_status == undefined? {}: invoice_status, 
            ...
            payment_status: payment_status == undefined ? {}: payment_status,
            date: date == undefined? new Date.now(): date, 
            ...
            shipping_or_delivery_cost: shipping_or_delivery_cost == undefined? "": shipping_or_delivery_cost, 
        };
...
var SalesInvoiceInstance = new Sales(); 
  

export { Sales, SalesInvoiceInstance };